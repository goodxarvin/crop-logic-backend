...
router.register("product-add-ons", views.ProductAddOnViewSet, basename="product-add-ons")
...
add_on_router.register("add-on-assignments", views.AddOnAssignmentViewSet, basename="add-on-assignments")
...
sellable_router.register("add-on-assignments", views.AddOnAssignmentViewSet, basename="add-on-assignments")

variants_router = NestedDefaultRouter(sellable_router, "variants", lookup="variant")
variants_router.register("attributes", views.ProductAttributeValueViewSet, basename="attributes")

sku_router = NestedDefaultRouter(sellable_router, "skus", lookup="sku")
sku_router.register("bundle-items", views.ProductBundleItemViewSet, basename="bundle-items")

bundle_router = NestedDefaultRouter(router, "bundles", lookup="bundle")
bundle_router.register("bundle-items", views.ProductBundleItemViewSet, basename="bundle-items")
